  ...
  return (
    <div className="content-wrapper">
      ...
      <div className="how-to-play-sections">
        <InstructionCard 
          title="Court Layout"
          imgName={`${process.env.PUBLIC_URL}/images/courtdimensions.jpg`}
        ...
        <InstructionCard 
          ...
          imgName={`${process.env.PUBLIC_URL}/images/cs1.webp`}
        ...
        <InstructionCard 
          title="Point System"
          imgName={`${process.env.PUBLIC_URL}/images/pointsystem.jpg`}
